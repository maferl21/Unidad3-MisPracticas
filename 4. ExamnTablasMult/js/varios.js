			...
			for (i=1; i<=10; i++){
				...
				if (isNaN(sValorCapturado))
					...
					if (nCapturado == (nTabla*i)){
						...
						document.getElementById("txtResultado"+i).style="Background-color: green; color: white;";
						...
						document.getElementById("txtResultado"+i).style="Background-color: red; color: white;";
